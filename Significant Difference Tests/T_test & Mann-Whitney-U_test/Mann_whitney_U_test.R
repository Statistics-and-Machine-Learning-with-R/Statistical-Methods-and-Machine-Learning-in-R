...
2- To run the code, select the whole code and run as source (top right in this window) & enter parameters
   ...
   c- Parameter(paired) value for U-test, either TRUE or FALSE
...
PairedValue <- readline(prompt = "Enter TRUE/FALSE for Paired or Unpaired in U-Test: ")
